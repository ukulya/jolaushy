...
const Notifications = (props)=>{
    return(
        <div>
            <CommonNavbar title="Уведомления"/>
            <div className="container mt-20">
                <div className="custom-card br-25 text_xs p-15">
                    ...
                    <div className="text-center mt-20">
                        <button className="white_btn custom_btn btn-sm mr-20">Игнорировать <span className="material-icons">cancel</span></button>
                        <button className="blue_btn custom_btn btn-sm">Принять запрос <span className="material-icons">arrow_forward</span></button>
                    </div>
                </div>
            </div>
        </div>
